...
## Page structure
8. **Group headers, not big section headings, for lists.** Settings-style pages use small group headers
   (15/20 600 muted, sentence case, 16px inset) above each ListGroup, like iOS Settings, instead of 22px section
   titles above every card. Keep 22px Section titles only for content regions on Today, Timeline and Blood tests
   ("Coming up", "This week", "Your results").
