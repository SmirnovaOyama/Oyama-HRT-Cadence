...
interface EstimateInfoModalProps {
     ...
     * C26, "How this was worked out"). When given, the sheet leads with them and
    ...
    return createPortal(
        <div className="modal-overlay z-[60]" onClick={onClose}>
            <div className="modal-shell" onClick={e => e.stopPropagation()}>
                <div className="modal-card" role="dialog" aria-modal="true" aria-labelledby="estimate-info-title">
                    <h3 id="estimate-info-title" className="modal-title">
                        {explained ? t('today.info.title') : t('modal.estimate.title')}
                    </h3>
